	...
	\section{Machine Learning Algorithms}
		...
		\subsection{ID3}
			\subsubsection{Description}
				...
				The computation required to do this is unfeasibly large.
				...
				Then the sum of the entropy for each branch is calculated and subtracted from the total entropy. 
				The goal is to maximize this difference so the tree will be small and more general.
